...
describe('health-check', () => {
  ...
  test('should return current timestamp', (done) => {
    const date = new Date();
    mockdate.set(date);
  ...
  test('should show mongo status as "up" when mongo is up', (done) => {
  ...
  test('should show mongo status as "down" when mongo is down', (done) => {
